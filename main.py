...
class Game:
    ...
    def redraw(self):
        ...
        rdr.Redraw(self.points, border_points, Voronoi_points, self.LinePoints, small_edges, border_edges)
        # print("Redrawing")
...
if __name__ == "__main__":
    game = Game(Voronoi_lines=True, Triengulate_lines=False, Triengulate_dead_points=True)
